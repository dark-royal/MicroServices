...
public class UserService implements RegisterUseCase, GetUserUseCase,FindUserUseCase, LoginUseCase, UpdateUserUseCase, DeleteUserUseCase {
    ...
    public UserService(UserOutputPort userOutputPort, KeycloakAdapter keycloakAdapter, UserPersistenceMapper userPersistenceMapper, PasswordEncoder passwordEncoder, PremblyOutputPort premblyOutputPort, IdentityManagerOutputPort identityOutputPort) {
